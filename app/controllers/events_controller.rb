class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:price_category,:price_category_id, :name, :place, :place_type, :date_start, :date_finish, :date_load, :greeter, :description,:client_id, :condition,:guests, event_curator_users_attributes: [:id,:user_id,:event_id,:custom], client_attributes: [:name, :phone, :email, :notes], event_prices_attributes: [:id, :price_id, :custom_name, :custom_description, :cost, :count,:image_name, :price_category_id,  :_destroy,prices_attributes:[:image_file_name]])
