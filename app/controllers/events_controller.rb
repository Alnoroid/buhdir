class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:name, :place, :place_type, :event_type, :date_start, :date_finish, :date_load, :greeter, :description,:client_id, :condition, event_curator_users_attributes: [:id,:user_id,:event_id,:custom], client_attributes: [:name, :phone, :email, :notes], event_prices_attributes: [:id, :custom_name, :custom_description, :_destroy])
